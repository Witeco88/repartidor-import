const CACHE='repartidor-v30';
const ASSETS=['./','./index.html','./manifest.json','./icon-180.png','./icon-512.png','./home.svg','./history.svg','./summary.svg','./settings.svg','./save.svg','./copy.svg','./share.svg','./equal.svg'];
